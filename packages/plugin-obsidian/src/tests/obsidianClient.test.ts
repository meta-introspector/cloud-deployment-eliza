...
describe("ObsidianProvider", () => {
    ...
    beforeEach(async () => {
        ...
        obsidianProvider = await ObsidianProvider.create(
            mockRuntime,
            mockPort,
            mockToken
        );
    ...
    describe("create and connect", () => {
        ...
        it("should throw error if connection fails", async () => {
            ...
            await expect(
                ObsidianProvider.create(mockRuntime, mockPort, mockToken)
        ...
        it("should reuse existing instance", async () => {
            ...
            const instance2 = await ObsidianProvider.create(
                mockRuntime,
                mockPort,
                mockToken
            );
    ...
    describe("vault operations", () => {
        ...
        describe("getActiveNote", () => {
            ...
            it("should handle no active note", async () => {
                ...
                await expect(obsidianProvider.getActiveNote()).rejects.toThrow(
                    "No active file found in Obsidian"
                );
            });
        });
    });
    ...
    describe("search operations", () => {
        describe("search", () => {
            it("should perform plaintext search", async () => {
                ...
                const results = await obsidianProvider.search(
                    "test",
                    "plaintext"
                );
        ...
        describe("simpleSearch", () => {
            it("should perform simple search with OR operator", async () => {
                ...
                const results = await obsidianProvider.searchKeywords(
    ...
    describe("error handling", () => {
        it("should handle HTTP errors", async () => {
            ...
            await expect(obsidianProvider.listNotes()).rejects.toThrow(
