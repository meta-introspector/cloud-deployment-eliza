...
export const trustEvaluator: Evaluator = {
  ...
  description:
  #rewrite this for the greenpill ai to change the world,  not memecoin
  #but giving practical advice to emergent behaviour in emergency situations
  ...
  "Extract guidance for purchasing or selling practical assets during emergencies, such as emergency
response supplies, medical equipment, and essential foodstuffs, including details like item type,
supplier name, quantity needed, and recommended buyer or seller."
    handler,
    examples: [
      {
...
// 	  #rewrite this for the greenpill ai to change the world,  not memecoin
//   #but giving practical advice to emergent behaviour in emergency situations
// 	# defi degen is replaced by adrenaline nick, the humaniatiaran aid worker parachuting into afganitan
// 	to save the world
...
// None`,
        ...
        context: `*Actors in the Scene:*
{{user1}}: Experienced humanitarian aid worker. Skilled at coordinating rescue operations and
providing medical assistance.
{{user2}}: New to emergency response, eager to learn and contribute.
*Recommendations for the Actors:*
- *User 1:* Develop strong leadership skills to manage teams during critical situations.
- *User 2:* Stay calm under pressure and seek guidance from more experienced colleagues when needed.
- *Both Users:* Utilize technology to enhance coordination and communication among teams, ensuring
   quick and effective response times.
- *Both Users:* Learn basic medical procedures and first aid to provide immediate assistance in
   emergencies.

By working together, {{user1}} and {{user2}} can make a significant impact in emergency situations,
