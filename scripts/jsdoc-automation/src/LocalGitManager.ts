...
export class LocalGitManager {
    ...
    constructor(public repository: Repository) {
        console.log("going to scan",repository.rootDirectory);
        this.git =  { repo :  repository.rootDirectory  }
        //git.simpleGit(repository.rootDirectory);
    }
...
//     }
    ...
    public async getLastNCommitDiffs(count: number) {
        ...
        //try {
            ...
            const log = await gitlog(this.git);
            console.log(log);
            //     maxCount: count,
            //     // format: {
            //     //     hash: '%H',
            ...
            // const  process = (commit:any) => {
            //     console.log("COMMIT", commit);
            //     console.log("COMMIT", commit.diff?.files);
    ...
    public async getFilesInPullRequest(
        ...
        const commitDiffs = await this.getLastNCommitDiffs(1000);
        return []
        //console.log("DIFFS",commitDiffs);
