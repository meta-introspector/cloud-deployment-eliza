...
- can't build framework - followed quick start - bun run build error [\#1714](https://github.com/elizaOS/eliza/issues/1714)
...
- Quick start guide bug - bun start [\#1552](https://github.com/elizaOS/eliza/issues/1552)
...
- bug: bun run dev not working with characterfiles [\#1452](https://github.com/elizaOS/eliza/issues/1452)
...
- v0.1.6 When running on the gitpod , not able to chat in terminal when bun start , "Error starting agent for character Eliza" [\#1328](https://github.com/elizaOS/eliza/issues/1328)
...
- Fix: Update package.json with build command to match the dockerfile command [\#1527](https://github.com/elizaOS/eliza/pull/1527) ([vanshika-srivastava](https://github.com/vanshika-srivastava))
...
- fix: update bun lock [\#1457](https://github.com/elizaOS/eliza/pull/1457) ([odilitime](https://github.com/odilitime))
...
- docs: Add documentation on bun node version [\#1350](https://github.com/elizaOS/eliza/pull/1350) ([trbutler4](https://github.com/trbutler4))
...
- Unable to run `bun install` on v0.1.6-alpha.4 [\#1167](https://github.com/elizaOS/eliza/issues/1167)
...
- bun start --character="characters/trump.character.json" [\#1161](https://github.com/elizaOS/eliza/issues/1161)
...
- fix: bun lock file [\#1292](https://github.com/elizaOS/eliza/pull/1292) ([shakkernerd](https://github.com/shakkernerd))
...
- chore: Revert "fix: bun lockfile" [\#1275](https://github.com/elizaOS/eliza/pull/1275) ([shakkernerd](https://github.com/shakkernerd))
- fix: bun lockfile [\#1273](https://github.com/elizaOS/eliza/pull/1273) ([shakkernerd](https://github.com/shakkernerd))
...
- bun install fails on m1 mac \[Fixed with xcode-select reinstall\] [\#1146](https://github.com/elizaOS/eliza/issues/1146)
...
- bun install updates bun lockfile when it should not [\#1121](https://github.com/elizaOS/eliza/issues/1121)
...
- This command: bun start --characters="characters/tate.character.json" results in an error [\#817](https://github.com/elizaOS/eliza/issues/817)
- Characters Do Not Actually Use ExamplePost or ExampleMessage [\#791](https://github.com/elizaOS/eliza/issues/791)
- `bun run dev` does not work out of the box [\#780](https://github.com/elizaOS/eliza/issues/780)
...
- Error: Property 'clients' does not exist on type 'Plugin' in src/index.ts during bun start [\#423](https://github.com/elizaOS/eliza/issues/423)
...
- bun install fails on Ubuntu [\#215](https://github.com/elizaOS/eliza/issues/215)
...
- chore: fix broken bun lockfile [\#1103](https://github.com/elizaOS/eliza/pull/1103) ([shakkernerd](https://github.com/shakkernerd))
...
- chore: kill bun start [\#1093](https://github.com/elizaOS/eliza/pull/1093) ([shakkernerd](https://github.com/shakkernerd))
...
- chore: fix broken bun lockfile [\#1081](https://github.com/elizaOS/eliza/pull/1081) ([shakkernerd](https://github.com/shakkernerd))
...
- fix: Fix bun lockfiles [\#1055](https://github.com/elizaOS/eliza/pull/1055) ([jzvikart](https://github.com/jzvikart))
...
- Error bun start - Promise.withResolvers\(\): pdfjs-dist [\#902](https://github.com/elizaOS/eliza/issues/902)
...
- `bun  start` crashes if there is too much data in knowledge [\#866](https://github.com/elizaOS/eliza/issues/866)
...
- bun install error - ELIFECYCLE Exit code 1 [\#720](https://github.com/elizaOS/eliza/issues/720)
...
- Severe Bug - The program fails to start with the command 'bun start', urgent fix required [\#326](https://github.com/elizaOS/eliza/issues/326)
- bun start reports an error and cannot be started. Why is this? I installed it according to the documentation steps. [\#288](https://github.com/elizaOS/eliza/issues/288)
